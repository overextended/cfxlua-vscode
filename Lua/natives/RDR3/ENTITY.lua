...
---@return any
function GetMatchingEntities(volume, itemSet, entityType, p3, p4) end
...
---@param entity number
---@return any, any
function N_0x8e46e18aa828334f(entity) end
...
---@param time number
---@return any, any
function SetEntityAnimCurrentTime(entity, time) end
...
---@return any, any
function SetEntityAnimSpeed(entity, speedMultiplier) end
...
---@param bInit boolean
---@return any
function CreateFootpathTrail(p0, bUseSnowOffset, p3, p4, p5, p6, p7, p8, p9, p10, bInit) end
